...
export default function ProvidersPage({ onSelectProvider }: ProvidersPageProps) {
  return (
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between py-2">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs text-slate-600 dark:text-slate-400">({provider.reviews} reviews)</span>
                </div>
              ...
              <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 pt-2 border-t border-slate-200 dark:border-slate-800">
